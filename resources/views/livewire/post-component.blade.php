                                ...
                                <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                                    ...
                                    <form wire:submit={{ $postId ? 'update' : 'store ' }}>
                                        <div class="mb-4">
                                            ...
                                            <input type="text" wire:model.blur="form.title" id="title"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="body" wire:model="form.body" rows="4" class="w-full border border-gray-300 px-4 py-2 rounded"></textarea>
                                            <span class="text-red-500">
                                                @error('form.body')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="file" wire:model="form.image" id="title"
                                                class="w-full border border-gray-300 px-4 py-2 rounded">
                                        </div>
                                        ...
                                        {{-- @if ($postId)
                                        <div wire:dirty.remove>Unsaved changes...</div>
                                        @endif --}}
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @forelse ($posts as $post)
                                ...
                                <tr class="bg-white
                                    ...
                                    <td class="px-6 py-4">
                                        <button wire:click="edit({{ $post->id }})" class="">
                                        ...
                                        <button wire:click="delete({{ $post->id }})" class="">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="ml-2 mt-0 w-4 h-4">
                                                <path stroke-linecap="round" stroke-linejoin="round"
